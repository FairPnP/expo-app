...
import { Button, ModalRef, ReviewStarsSelect, StandardModal, TextInput, Text, LoadingOverlay, Title } from '../components'
...
export const UserReviewModal = forwardRef<ModalRef, UserReviewModalProps>((props, ref) => {
  ...
  return (
    <StandardModal title={"User Review"} ref={ref} {...modalProps}>
      ...
      <Text>Rating</Text>
      <ReviewStarsSelect style={{ marginBottom: 24 }} ref={starsRef} initialStars={5} />
      <FormProvider {...formMethods}>
        <TextInput
          label="Message"
          name="message"
          numberOfLines={5}
          inputStyle={{ minWidth: 280, minHeight: 60, marginBottom: 24 }}
        />
